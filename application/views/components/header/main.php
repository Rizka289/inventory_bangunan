...
<html lang="id">
<?php 
    $manifest = json_decode(file_get_contents(get_path("static", "docs/manifest.json")));
?>
<head>
    <meta charset="UTF-8">
    ...
    <?php if(isset($thumb) || isset($manifest->image)): ?>
        <meta property="og:image" content="<?php echo isset($thumb) ? get_path('static', $thumb) : get_path('static', $manifest->image) ?>">
    <?php endif?>
    <meta property="og:image:width" content="2250" />
    <meta property="og:image:height" content="2250" />
    <?php if(isset($manifest->image)): ?>
    <link rel="icon" type="image/gif" href="<?php echo  get_path('static',  $manifest->image) ?>">
    <?php endif?>
